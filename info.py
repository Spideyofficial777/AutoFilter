...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5518489725 7965267063').split()] # Replace with the actual admin ID(s) to add
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002294764885').split()]  # Channel id for auto indexing (make sure bot is admin)
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002294764885'))  # Log channel id (make sure bot is admin)
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002294764885'))  # Bin channel id (make sure bot is admin)
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002453024937'))  # Notification of those who verify will be sent to your channel
...
MULTI_FSUB = [int(channel_id) for channel_id in environ.get('MULTI_FSUB', '-1001959922658 -1002453024937 -1002470391435').split() if re.match(r'^-?\d+$', channel_id)]  # Channel for force sub (make sure bot is admin)
...
#Auto approve 
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1001959922658 -1002453024937 -1002470391435').split()]
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002423451263'))  # Log channel id (make sure bot is admin)
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Spideyofficial777/12')  # Tutorial video link for opening shortlink website
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))

# ============================
# Channel & Group Links Configuration
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+KTXnXf_YPxJlOGRl')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/spideyofficialupdatez')
...
OWNERID = int(os.environ.get('OWNERID', '5518489725'))  # Replace with the actual admin ID
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', '-1002294764885'))
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'SPIDEY'))
MULTI_CLIENT = False
name = str(environ.get('name', 'SPIDEYOFFICIAL'))
